...
| C4   | ✓         | ✓ (Spearman 0.48, p=0.01, n=28; no-view -0.17 n=21 — regime, not within) | ✓ (Spearman 0.81, p=0.005, n=10; no-pose +0.60 n=6) | ✓ direction-only (Spearman +0.50, p=0.67, n=3) | Spearman + scatter plot |
